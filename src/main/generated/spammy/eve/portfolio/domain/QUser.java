...
public class QUser extends EntityPathBase<User> {
    ...
    private static final long serialVersionUID = -882046820L;
    ...
    public final QUserSettings settings;
    ...
    public QUser(Class<? extends User> type, PathMetadata metadata, PathInits inits) {
        ...
        this.settings = inits.isInitialized("settings") ? new QUserSettings(forProperty("settings"), inits.get("settings")) : null;
    }
